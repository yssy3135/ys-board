package ys.board.hotarticle.repository;
...
public class ArticleCreatedTimeRepository {
    ...
    // 게시글 생성 시간을 저장아흫 이유는 종아요 이벤트가 왔는데, 이 이벤트에 대한 게시글이 오늘 게시글인지 확인하려면
    // 게시글 서비스에 조회가 필요하다.
    // 하지만 게시글 생성 시간을 저장하고 있으면, 오늘 게시글인지 게시글 서비스에 조회 없이 알 수 있다.
