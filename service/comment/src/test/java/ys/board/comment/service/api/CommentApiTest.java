...
//        commentId=146643795249766400
//        commentId=146643795895689216
//        commentId=146643795941826560
    }
    ...
    void read() {
        CommentResponse response = restClient.get()
                .uri("/v1/comments/{commentId}", 146643795249766400L)
                .retrieve()
                .body(CommentResponse.class);
    ...
    void delete() {
        restClient.delete()
                .uri("/v1/comments/{commentId}", 146643795941826560L)
                .retrieve();
    }
